...
<body>
    ...
    <?php /* sub mv */ ?>
    <?php get_template_part(GET_PATH_R('template').'layout/l-submv', null, ['title' => 'ページがありません','lead'=>'Not Page'] ); ?>

<main>
    <section class="p-404 u-padding_ud40 u-color-bg__white">
    <div class="p-404__inner">
        ...
        <div class="p-contact__complete u-margin__t80">
            ...
            <div class="l-works__button__wrapper u-margin__t80">
                <a href="/" class="c-button__portfolio c-button__hover__back p-button__pf u-margin__auto">
                トップに戻る
                </a>
            </div>
        </div>
